...
- <Icon name="check" decorative size="small" /> Đồ ăn (bánh mì, cơm, phở...)
- <Icon name="check" decorative size="small" /> Quần áo, giày dép
- <Icon name="check" decorative size="small" /> Thẻ cào điện thoại
- <Icon name="check" decorative size="small" /> Trà sữa, cà phê
- <Icon name="check" decorative size="small" /> Mỹ phẩm, đồ dùng cá nhân
- <Icon name="check" decorative size="small" /> Xăng dầu (còn có thêm thuế môi trường!)
...
Hãy xem một ví dụ cụ thể về **thuế gián thu** (VAT) khi hai người có thu nhập khác nhau mua cùng một món hàng:
